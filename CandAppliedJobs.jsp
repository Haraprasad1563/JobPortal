  ...
  <body>
    ...
    <table class="table">
      <thead class="thead-dark">
		...
		<sql:setDataSource var="db" driver="com.mysql.cj.jdbc.Driver" url="jdbc:mysql://localhost:3306/jobs?useTimeZone=true&serverTimezone=UTC" user="root" password="Hara_HS@1563"/>
		
		<sql:query var="rs" dataSource="${db}">select jobid, role, compname, location, visa, comp, jd from jobs where jobid in(select jobid from candidatesjob where uid=${uid})</sql:query>
