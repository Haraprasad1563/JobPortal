  ...
  <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
    ...
    <table class="table">
      <thead class="thead-dark">
		...
		<sql:query var="rs" dataSource="${db}">select jobid, role, compname, location, visa, comp, jd from jobs where jobid not in(select jobid from jobs where cid=${cid})</sql:query>
