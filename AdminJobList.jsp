  ...
  <div class="container-xxl bg-white p-0">
    ...
    <table class="table">
      <thead class="thead-dark">
		...
		<sql:setDataSource var="db" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:3306/jobportal?useTimeZone=true&serverTimezone=UTC" user="root" password="admin@123"/>
