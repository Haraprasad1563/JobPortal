...
public class PostJob extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int rid = Integer.parseInt(request.getParameter("jobid")); 
		...
		String url = "jdbc:mysql://localhost:3306/jobs?useTimeZone=true&serverTimezone=UTC";

		try {
			
			Class.forName("com.mysql.cj.jdbc.Driver");
			Connection con = DriverManager.getConnection(url, "root", "Hara_HS@1563");
