...
<html lang="en">
  ...
  <div id="spinner" class="show bg-white position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
    ...
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
    	...
    	<sql:setDataSource var="db" driver="com.mysql.cj.jdbc.Driver" url="jdbc:mysql://localhost:3306/jobportal?useTimeZone=true&serverTimezone=UTC" user="root" password="admin@123"/>
    ...
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
	    ...
	    <table class="table">
	      ...
	      <tbody>
			...
			<sql:query var="rs" dataSource="${db}">select cid, name, email, phone from candidates where cid in(select cid from candidate where jobid=<%=jobid%>)</sql:query>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+91 9668581157</p>
                        <p class="mb-2"><i class="fa fa-envelope me-3"></i>haraprasadsenapati9@gmail.com</p>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
							...
							Designed By <a class="border-bottom" href="">Haraprasad Senapati</a>
                        </div>
