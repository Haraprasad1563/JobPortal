...
<body>
	...
	<div
		...
		<table class="table">
			...
			<sql:setDataSource var="db" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:3306/jobs?useTimeZone=true&serverTimezone=UTC" user="root" password="Hara_HS@1563" />
